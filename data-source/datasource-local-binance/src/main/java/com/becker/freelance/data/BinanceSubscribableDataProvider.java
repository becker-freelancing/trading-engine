...
public class BinanceSubscribableDataProvider extends SubscribableDataProvider {
    ...
    public BinanceSubscribableDataProvider(Pair pair, Synchronizer synchronizer) {
        this.pair = pair;
    ...
    private TimeSeries readTimeSeries() {
        ...
        BinanceDataProvider binanceDataProvider = new BinanceDataProvider(pair);
        return binanceDataProvider.readTimeSeries(
