...
public class KrakenSubscribableDataProvider extends SubscribableDataProvider {
    ...
    public KrakenSubscribableDataProvider(Pair pair, Synchronizer synchronizer) {
        this.pair = pair;
    ...
    private TimeSeries readTimeSeries() {
        ...
        KrakenDataProvider binanceDataProvider = new KrakenDataProvider(pair);
