...
public class KrakenPairProvider implements PairProvider {
    ...
    public List<Pair> get() {
        return List.of(
                ...
                from("PAXG", "USD", 1, "GLD/USD M1", 10., 0.1, 1., 1., 0.05, 1),
                from("PAXG", "USD", 5, "GLD/USD M5", 10., 0.1, 1., 1., 0.05, 1),
                from("PAXG", "USD", 15, "GLD/USD M15", 10., 0.1, 1., 1., 0.05, 1),
                from("PAXG", "USD", 30, "GLD/USD M30", 10., 0.1, 1., 1., 0.05, 1),
                from("PAXG", "USD", 60, "GLD/USD H1", 10., 0.1, 1., 1., 0.05, 1),
                from("PAXG", "USD", 240, "GLD/USD H4", 10., 0.1, 1., 1., 0.05, 1),
                from("PAXG", "USD", 720, "GLD/USD H12", 10., 0.1, 1., 1., 0.05, 1),
                from("PAXG", "USD", 1440, "GLD/USD T1", 10., 0.1, 1., 1., 0.05, 1),
                ...
                from("EUR", "USD", 1, "EUR/USD M1", 10., 1., 2., 1., 0.0333, 100_000),
                from("EUR", "USD", 5, "EUR/USD M5", 10., 1., 2., 1., 0.0333, 100_000),
                from("EUR", "USD", 15, "EUR/USD M15", 10., 1., 2., 1., 0.0333, 100_000),
                from("EUR", "USD", 30, "EUR/USD M30", 10., 1., 2., 1., 0.0333, 100_000),
                from("EUR", "USD", 60, "EUR/USD H1", 10., 1., 2., 1., 0.0333, 100_000),
                from("EUR", "USD", 240, "EUR/USD H4", 10., 1., 2., 1., 0.0333, 100_000),
                from("EUR", "USD", 720, "EUR/USD H12", 10., 1., 2., 1., 0.0333, 100_000),
                from("EUR", "USD", 1440, "EUR/USD T1", 10., 1., 2., 1., 0.0333, 100_000)
        );
    }
