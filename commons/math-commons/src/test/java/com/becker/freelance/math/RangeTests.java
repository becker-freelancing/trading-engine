 ...
 * @run main com.becker.freelance.math.RangeTests
 * @run main/othervm -XX:+IgnoreUnrecognizedVMOptions -XX:+EliminateAutoBox -XX:AutoBoxCacheMax=20000 com.becker.freelance.math.RangeTests
