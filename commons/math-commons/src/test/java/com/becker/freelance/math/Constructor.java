 ...
 * @test
 * @bug 4259453 8200698
 * @summary Test constructors of Decimal
 * @library ..
 * @run testng com.becker.freelance.math.Constructor
 */
...
public class Constructor {
    ...
    public void stringConstructor() {
        Decimal bd = new Decimal("1.2e");
    }

    @Test(expectedExceptions = NumberFormatException.class)
    public void charArrayConstructorNegativeOffset() {
        Decimal bd = new Decimal(new char[5], -1, 4, null);
    }

    @Test(expectedExceptions = NumberFormatException.class)
    public void charArrayConstructorNegativeLength() {
        Decimal bd = new Decimal(new char[5], 0, -1, null);
    }

    @Test(expectedExceptions = NumberFormatException.class)
    public void charArrayConstructorIntegerOverflow() {
        try {
            Decimal bd = new Decimal(new char[5], Integer.MAX_VALUE - 5,
                    6, null);
    ...
    public void charArrayConstructorIndexOutOfBounds() {
        Decimal bd = new Decimal(new char[5], 1, 5, null);
    }
}
